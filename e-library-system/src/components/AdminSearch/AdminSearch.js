...
function AdminSearch() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3000/AddBook")
      .then((response) => {
  ...
  const resetFilter = (event) => {
    ...
    setSearch("");
    if (
      JSON.parse(sessionStorage.getItem("bookDetails")) &&
      JSON.parse(sessionStorage.getItem("bookDetails")).length > 0
    ) {
      setList(JSON.parse(sessionStorage.getItem("bookDetails")));
    }
  };
      ...
      <div className="modal" id="delete" role="dialog">
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            ...
            <div className="modal-body">Book details deleted successfully</div>
            <div className="modal-footer">
              <button
                type="button"
